...
class e310_fm_receiver_zmq_host(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "E310 Fm Receiver Zmq Host", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "e310_fm_receiver_zmq_host")
        ...
        self._audio_gain_range = qtgui.Range(0, 1, 0.1, 0.5, 100)
        ...
        self.zeromq_pull_source_0_0_0 = zeromq.pull_source(gr.sizeof_gr_complex, 1, 'tcp://172.16.1.202:9999', 100, False, (-1), False)
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_float, 1, 'tcp://172.16.1.202:9997', 100, False, (-1), False)
        self.xmlrpc_client0 = ServerProxy('http://'+"172.16.1.202"+':30000')
        self.xmlrpc_client = ServerProxy('http://'+"172.16.1.202"+':30000')
        self._rx_gain_range = qtgui.Range(0, 70, 1, 50, 200)
        self._rx_gain_win = qtgui.RangeWidget(self._rx_gain_range, self.set_rx_gain, "RF Gain", "counter_slider", float, QtCore.Qt.Horizontal)
